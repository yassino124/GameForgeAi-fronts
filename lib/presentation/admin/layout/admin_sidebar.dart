                  ...
                  child: Column(
                    children: [
                      _NavItem(
                        ...
                        label: 'Overview',
                        path: '/admin/overview',
                        isActive: location == '/admin/overview',
                      ),
                      _NavItem(
                        icon: Icons.people,
                        label: 'Users',
                      ...
                      _NavItem(
                        ...
                        isActive: location == '/admin/marketplace',
                      ),
                      _NavItem(
                        icon: Icons.build,
                        label: 'Builds',
                        path: '/admin/builds',
                        isActive: location == '/admin/builds',
                      ),
                      _NavItem(
                    ...
                    Row(
                      children: [
                        UserAvatar(
                          ...
                          username:
                              authProvider.user?['username']?.toString() ?? 'A',
                          radius: 20,
      ...
      child: MouseRegion(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            border: isActive
                ? Border(
                    left: BorderSide(color: AdminTheme.accentNeon, width: 3),
                  )
                : null,
          ),
          child: ListTile(
